/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 4870c55f24e45bb100aff48d469b0ebb)
// Runtime types generated with workerd@1.20260903.1 2026-09-05 
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://rabblebabble-staging.workers.dev" | "https://rabblebabble.cc";
	SIGNUP_MODE: "invite";
	EMAIL_MODE: "resend";
	...
	USER_DAILY_AUDIO_SECONDS: "600" | "3600";
	USER_DAILY_TRANSCRIBE_CALLS: "20" | "60";
	USER_DAILY_CHAT_CALLS: "20" | "120";
	USER_DAILY_SPEND_MICROS: "10000" | "50000";
	GLOBAL_DAILY_SPEND_MICROS: "100000" | "1000000";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		DB: D1Database;
		ASSETS: Fetcher;
		APP_ORIGIN: "https://rabblebabble-staging.workers.dev";
		SIGNUP_MODE: "invite";
		EMAIL_MODE: "resend";
		EMAIL_FROM: "RabbleBabble <login@send.rabblebabble.cc>";
		MAGIC_LINK_TTL_SECONDS: "900";
		SESSION_TTL_SECONDS: "7776000";
		REQUIRE_SAME_DEVICE_LINK: "true";
		USER_DAILY_AUDIO_SECONDS: "600";
		USER_DAILY_TRANSCRIBE_CALLS: "20";
		USER_DAILY_CHAT_CALLS: "20";
		USER_DAILY_SPEND_MICROS: "10000";
		GLOBAL_DAILY_SPEND_MICROS: "100000";
		TRANSCRIBE_RESERVE_SECONDS: "300";
		PRICE_TRANSCRIBE_MICROS_PER_HOUR: "40000";
		PRICE_CHAT_IN_MICROS_PER_MTOK: "75000";
		PRICE_CHAT_OUT_MICROS_PER_MTOK: "300000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "SIGNUP_MODE" | "EMAIL_MODE" | "EMAIL_FROM" | "MAGIC_LINK_TTL_SECONDS" | "SESSION_TTL_SECONDS" | "REQUIRE_SAME_DEVICE_LINK" | "USER_DAILY_AUDIO_SECONDS" | "USER_DAILY_TRANSCRIBE_CALLS" | "USER_DAILY_CHAT_CALLS" | "USER_DAILY_SPEND_MICROS" | "GLOBAL_DAILY_SPEND_MICROS" | "TRANSCRIBE_RESERVE_SECONDS" | "PRICE_TRANSCRIBE_MICROS_PER_HOUR" | "PRICE_CHAT_IN_MICROS_PER_MTOK" | "PRICE_CHAT_OUT_MICROS_PER_MTOK" | "GROQ_BASE_URL" | "GROQ_API_KEY" | "RESEND_API_KEY" | "IP_HASH_PEPPER">> {}
}
